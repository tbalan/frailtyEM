...
[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/frailtyEM)](https://cran.r-project.org/package=frailtyEM)

[![CRAN_Downloads_Badge](https://cranlogs.r-pkg.org/badges/frailtyEM)](http://cran.rstudio.com/web/packages/frailtyEM/index.html)
...
Univariate and multivariate data with left truncation are supported, including recurrent events data in Andersen-Gill formulation.
