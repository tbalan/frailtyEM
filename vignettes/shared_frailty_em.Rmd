...
$$
To parametrize it with one parameter $\theta > 0$ we take a $\tilde\theta = 1 + \theta$ (note: has to be larger than 1!) and we have $\beta = 1 - 1/\tilde\theta$ and $\alpha = \tilde\theta / ( \tilde\theta - 1)$. 
Another parametrization (Hougaard, `parfm`) is obtained when setting $\alpha = 1$ and $\beta = 1 - 1/\tilde\theta$. 
